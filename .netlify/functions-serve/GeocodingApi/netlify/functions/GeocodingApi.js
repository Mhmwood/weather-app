...
// netlify/functions/GeocodingApi.ts
var GeocodingApi_exports = {};
__export(GeocodingApi_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(GeocodingApi_exports);
...
var OPENCAGE_API_KEY = process.env.OPENCAGE_API_KEY;
